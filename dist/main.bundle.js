...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__company_info_company_info_component__ = __webpack_require__("../../../../../src/app/company-info/company-info.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15__status_message_status_message_component__ = __webpack_require__("../../../../../src/app/status-message/status-message.component.ts");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_19__user_form_user_form_component__ = __webpack_require__("../../../../../src/app/user-form/user-form.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_20__billing_record_billing_record_component__ = __webpack_require__("../../../../../src/app/billing-record/billing-record.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_21__billing_record_form_billing_record_form_component__ = __webpack_require__("../../../../../src/app/billing-record-form/billing-record-form.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_22__invoice_form_invoice_form_component__ = __webpack_require__("../../../../../src/app/invoice-form/invoice-form.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_23__invoice_invoice_component__ = __webpack_require__("../../../../../src/app/invoice/invoice.component.ts");
...
AppModule = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__angular_core__["b" /* NgModule */])({
        declarations: [
            __WEBPACK_IMPORTED_MODULE_14__company_info_company_info_component__["a" /* CompanyInfoComponent */],
            ...
            __WEBPACK_IMPORTED_MODULE_15__status_message_status_message_component__["a" /* StatusMessageComponent */],
            __WEBPACK_IMPORTED_MODULE_18__user_user_component__["a" /* UserComponent */],
            __WEBPACK_IMPORTED_MODULE_19__user_form_user_form_component__["a" /* UserFormComponent */],
            __WEBPACK_IMPORTED_MODULE_20__billing_record_billing_record_component__["a" /* BillingRecordComponent */],
            __WEBPACK_IMPORTED_MODULE_21__billing_record_form_billing_record_form_component__["a" /* BillingRecordFormComponent */],
            __WEBPACK_IMPORTED_MODULE_22__invoice_form_invoice_form_component__["a" /* InvoiceFormComponent */],
            __WEBPACK_IMPORTED_MODULE_23__invoice_invoice_component__["a" /* InvoiceComponent */],
        ],
        imports: [
        ...
        providers: [__WEBPACK_IMPORTED_MODULE_11__data_service__["a" /* DataService */], __WEBPACK_IMPORTED_MODULE_16__auth_guard_service__["a" /* AuthGuard */], __WEBPACK_IMPORTED_MODULE_17__auth_service__["a" /* AuthService */]],
...
module.exports = "<section @fadeInAnimation>\r\n  <ol class=\"breadcrumb\">\r\n    <li>\r\n      <a routerLink=\"/home\">Home</a>\r\n    </li>\r\n    <li>\r\n      <a routerLink=\"/billing-record\">Billing Records</a>\r\n    </li>\r\n    <li class=\"active\">Manage Billing Record</li>\r\n  </ol>\r\n\r\n  <a class=\"btn btn-primary\" routerLink=\"/billing-record\">Return to Billing Records</a>\r\n\r\n  <h1>Manage Billing Record</h1>\r\n\r\n  <app-status-message [successMessage]=\"successMessage\" [errorMessage]=\"errorMessage\"></app-status-message>\r\n\r\n  <form (ngSubmit)=\"saveBillingRecord(billingRecordForm)\" #billingRecordForm=\"ngForm\" class=\"form-horizontal\">\r\n\r\n      <input [ngModel]=\"billingRecord?.id\" ngModel type=\"hidden\" name=\"id\">\r\n    <div class=\"form-group\">\r\n      <label for=\"recordType\" class=\"col-sm-2 control-label\">Record Type</label>\r\n      <div class=\"col-sm-10\">\r\n        <!-- {{ billingRecord?.dtype }} -->\r\n        <select required [ngModel]=\"billingRecord?.dtype\" ngModel #recordType=\"ngModel\" class=\"form-control\" id=\"recordType\" name=\"recordType\">\r\n          <option [ngValue]=\"null\">-- Select Type --</option>\r\n          <option value=\"FlatFeeBillingRecord\">Flat Fee</option>\r\n          <option value=\"RateBasedBillingRecord\">Rate Based</option>\r\n        </select>\r\n      </div>\r\n    </div>\r\n    <div class=\"form-group\">\r\n      <label for=\"client\" class=\"col-sm-2 control-label\">Client</label>\r\n      <div class=\"col-sm-10\">\r\n        <select required [ngModel]=\"billingRecord?.client.id\" ngModel #client=\"ngModel\" class=\"form-control\" id=\"client\" name=\"client\">\r\n          <option [ngValue]=\"null\">-- Select Client --</option>\r\n          <option *ngFor=\"let company of companies\" [ngValue]=\"company.id\">\r\n            {{ company.name }}\r\n          </option>\r\n        </select>\r\n      </div>\r\n    </div>\r\n    <div class=\"form-group\">\r\n      <label for=\"description\" class=\"col-sm-2 control-label\">Description</label>\r\n      <div class=\"col-sm-10\">\r\n        <input ngModel [ngModel]=\"billingRecord?.description\" #description=\"ngModel\" type=\"text\" class=\"form-control\" id=\"description\" name=\"description\" placeholder=\"Description\"\r\n          required minlength=\"5\" maxlength=\"30\">\r\n        <span *ngIf=\"formErrors.description\" class=\"text-danger\">\r\n          {{ formErrors.description }}\r\n        </span>\r\n      </div>\r\n    </div>\r\n    <div *ngIf=\"billingRecordForm.value.recordType === 'FlatFeeBillingRecord'\" class=\"form-group\">\r\n      <label for=\"amount\" class=\"col-sm-2 control-label\">Amount</label>\r\n      <div class=\"col-sm-10\">\r\n        <input ngModel [ngModel]=\"billingRecord?.amount\"  #amount=\"ngModel\" type=\"text\" class=\"form-control\" id=\"amount\" name=\"amount\" placeholder=\"e.g. 100.00\" required\r\n          pattern=\"^(\\d*\\.)?\\d+$\">\r\n        <span *ngIf=\"formErrors.amount\" class=\"text-danger\">\r\n          {{ formErrors.amount }}\r\n        </span>\r\n      </div>\r\n    </div>\r\n    <div *ngIf=\"billingRecordForm.value.recordType === 'RateBasedBillingRecord'\">\r\n      <div class=\"form-group\">\r\n        <label for=\"rate\" class=\"col-sm-2 control-label\">Rate</label>\r\n        <div class=\"col-sm-10\">\r\n          <input ngModel #rate=\"ngModel\" [ngModel]=\"billingRecord?.rate\" type=\"text\" class=\"form-control\" id=\"rate\" name=\"rate\" placeholder=\"e.g. 100.00\" required\r\n            pattern=\"^(\\d*\\.)?\\d+$\">\r\n          <span *ngIf=\"formErrors.rate\" class=\"text-danger\">\r\n            {{ formErrors.rate }}\r\n          </span>\r\n        </div>\r\n      </div>\r\n      <div class=\"form-group\">\r\n        <label for=\"quantity\" class=\"col-sm-2 control-label\">Quantity</label>\r\n        <div class=\"col-sm-10\">\r\n          <input ngModel #quantity=\"ngModel\" [ngModel]=\"billingRecord?.quantity\" type=\"text\" class=\"form-control\" id=\"quantity\" name=\"quantity\" placeholder=\"e.g. 10\" required\r\n            pattern=\"^(\\d*\\.)?\\d+$\">\r\n          <span *ngIf=\"formErrors.quantity\" class=\"text-danger\">\r\n            {{ formErrors.quantity }}\r\n          </span>\r\n        </div>\r\n      </div>\r\n    </div>\r\n    <div class=\"form-group\">\r\n      <div class=\"col-sm-offset-2 col-sm-10\">\r\n        <button [disabled]=\"!billingRecordForm.form.valid\" type=\"submit\" class=\"btn btn-primary\">Submit</button>\r\n      </div>\r\n    </div>\r\n  </form>\r\n</section>"
...
var BillingRecordFormComponent = (function () {
    ...
    BillingRecordFormComponent.prototype.getRecordForEdit = function () {
        var _this = this;
        this.route.params
            .switchMap(function (params) { return _this.dataService.getBillingRecord("billing-record", +params['id']); })
            .subscribe(function (billingRecord) { return _this.billingRecord = billingRecord; });
    ...
    BillingRecordFormComponent.prototype.saveBillingRecord = function (billingRecordForm) {
        ...
        if (typeof billingRecordForm.value.id === "number") {
            ...
            this.dataService.editRecord(endpoint, billingRecordForm.value, billingRecordForm.value.id)
                .subscribe(function (result) { return _this.successMessage = "Record updated successfully"; }, function (error) { return _this.errorMessage = error; });
        }
        else {
...
var BillingRecordComponent = (function () {
    ...
    BillingRecordComponent.prototype.trackByFn = function (index, item) {
        return index;
    };
    BillingRecordComponent.prototype.deleteRecord = function (id) {
        var _this = this;
        ...
        dialogRef.afterClosed().subscribe(function (result) {
            if (result) {
                _this.dataService.deleteRecord("billing-record", id)
                    .subscribe(function (company) { _this.successMessage = "Record(s) deleted succesfully"; _this.getBillingRecords(); }, function (error) { return _this.errorMessage = error; });
            }
        });
    };
...
/***/ "../../../../../src/app/company-info/company-info.component.css":
/***/ (function(module, exports, __webpack_require__) {
...
/***/ "../../../../../src/app/company-info/company-info.component.html":
/***/ (function(module, exports) {
...
/***/ "../../../../../src/app/company-info/company-info.component.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var CompanyInfoComponent = (function () {
    function CompanyInfoComponent(dataService, route) {
        this.dataService = dataService;
        this.route = route;
    }
    ...
    CompanyInfoComponent.prototype.getInvoices = function (id) {
        var _this = this;
...
CompanyInfoComponent = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["_14" /* Component */])({
        ...
        template: __webpack_require__("../../../../../src/app/company-info/company-info.component.html"),
        styles: [__webpack_require__("../../../../../src/app/company-info/company-info.component.css")],
        animations: [__WEBPACK_IMPORTED_MODULE_2__animations_fade_in_animation__["a" /* fadeInAnimation */]]
    }),
    __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_1__data_service__["a" /* DataService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__data_service__["a" /* DataService */]) === "function" && _a || Object, typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_3__angular_router__["c" /* ActivatedRoute */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_3__angular_router__["c" /* ActivatedRoute */]) === "function" && _b || Object])
...
var DataService = (function () {
    ...
    DataService.prototype.getRecordsById = function (endpoint, id) {
    ...
    DataService.prototype.getBillingRecord = function (endpoint, id) {
        var apiUrl = "" + this.baseUrl + endpoint + "/edit/" + id;
        return this.http.get(apiUrl, this.options)
            .map(this.extractData)
            .catch(this.handleError);
    };
...
var InvoiceFormComponent = (function () {
    ...
    InvoiceFormComponent.prototype.getRecordByCompany = function (event) {
        var _this = this;
        var temp = event.target.value;
        var colon = temp.indexOf(":");
        var id = event.target.value.slice(colon + 2);
        if (id != "null") {
            this.dataService.getRecordsById("billing-record", id)
                .subscribe(function (results) { return _this.specificBillingRecords = results; }, function (error) { return _this.errorMessage = error; });
        }
        else {
    ...
    InvoiceFormComponent.prototype.trackByFn = function (index, item) {
        return index;
    };
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__company_info_company_info_component__ = __webpack_require__("../../../../../src/app/company-info/company-info.component.ts");
...
var routes = [
    ...
    { path: 'company/id', component: __WEBPACK_IMPORTED_MODULE_12__company_info_company_info_component__["a" /* CompanyInfoComponent */], canActivate: [__WEBPACK_IMPORTED_MODULE_2__auth_guard_service__["a" /* AuthGuard */]] },
    // adding company-info path 
    { path: 'company-info/:id', component: __WEBPACK_IMPORTED_MODULE_12__company_info_company_info_component__["a" /* CompanyInfoComponent */], canActivate: [__WEBPACK_IMPORTED_MODULE_2__auth_guard_service__["a" /* AuthGuard */]] },
    ...
    { path: 'billing-record/edit/:id', component: __WEBPACK_IMPORTED_MODULE_9__billing_record_form_billing_record_form_component__["a" /* BillingRecordFormComponent */], canActivate: [__WEBPACK_IMPORTED_MODULE_2__auth_guard_service__["a" /* AuthGuard */]] },
